...
export default function PrivacyPolicy(){
  return(
    <div className='legal_notice'>
      ...
      <h3>Last updated at 12/23/2021</h3>
      <h2>Welcome to BattleVerse privacy notice!</h2>
      <p>
      ...
      <p>
        This Privacy Notice for California Residents supplements the information contained in BattleVerse Privacy Policy applies solely to all visitors, users, and others who reside in the State of California (”consumers” or “you”). We adopt this notice to comply with the California Consumer Privacy Act of 2018 (CCPA) and any terms defined in the CCPA have the same meaning when used in this Notice.
      </p>
      <p>
        Under the CCPA, a business that sells California residents' personal information to others: 1) must give notice to California residents before selling their personal information to others; and 2) must provide the right to opting out of the sale of their personal information. BattleVerse does not sell and has not in the past 12 months sold personal information, including personal information of anyone under 16 years old. Thus, these notification and opt-out requirements do not apply to BattleVerse.
      </p>
    </div>
  )
}